...
def extract_db():
	...
	if dbs != None:
		...
		print "[ES] No se han detectado bases de datos en el dispositivo conectado"
		print "[IN] No Database found on device"
		return ["No se han detectado bases de datos en el dispositivo conectado"]
